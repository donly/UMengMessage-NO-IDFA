#
#  Be sure to run `pod spec lint UMengMessage-NO-IDFA.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/donly/UMengMessage-NO-IDFA"
  ...
  s.author             = { "Donly" => "donly@magicalboy.com" }
  # Or just: s.author    = "Donly Chan"
  # s.authors            = { "Donly Chan" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Donly Chan"
